"""Repository listing and suggestion commands for GitHub Feedback Analysis CLI.

This module contains commands for listing repositories and suggesting
repositories for analysis based on activity and recency.
"""
...
def register_commands(app: typer.Typer) -> None:
    """Register repository commands with the CLI app."""
    app.command(name="list-repos")(list_repos)
    app.command(name="suggest-repos")(suggest_repos)
