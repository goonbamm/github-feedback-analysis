        ...
        definitions: List[Tuple[str, str, str]] = [
            (
                ...
                (
                    ...
                    "핵심 성과 3-5가지를 bullet로 정리해 주세요. 각 bullet에는 (1) 어떤 활동이나 "
                    "지표가 근거인지, (2) 조직에 준 구체적 영향과 비즈니스 가치가 무엇인지 포함해 주세요. "
                    "단, '장점'이나 '잘한 점'이라는 표현 대신 '달성한 성과'와 '그로 인한 임팩트'에 집중하세요."
                ),
            ),
            (
                ...
                "협업 및 리뷰 문화 분석",
                (
                    "Collaborations 관련 수치와 Spotlight Examples를 참고하여 "
                    "협업 패턴과 리뷰 문화를 분석해 주세요. 다음 관점에서 3-5가지 인사이트를 제공하세요: "
                    "(1) 현재 협업 방식의 특징, (2) 리뷰 참여도와 반응 시간, (3) 팀 커뮤니케이션 개선 기회. "
                    "긍정적/부정적 판단보다는 현황 분석과 개선 방향 제시에 집중하세요."
                ),
            ),
            (
                "quality_assessment",
                "코드 품질 및 안정성 현황",
                (
                    "Stability 관련 요약, Issues 통계, Spotlight 사례를 근거로 "
                    "코드베이스의 품질과 안정성 현황을 객관적으로 평가해 주세요. "
                    "(1) 현재 품질 수준을 나타내는 지표, (2) 주요 리스크 요인, (3) 안정성 개선을 위한 우선순위 영역 "
                    "3가지를 작성하세요. 가능하다면 Spotlight PR의 구체적 예시를 인용해 주세요."
                ),
            ),
            (
                "evolution_narrative",
                "변화와 발전의 여정",
                (
                    "Monthly Trends, Growth Highlights, Awards 정보를 기반으로 세 단락으로 구성된 서사를 작성해 주세요. "
                    "1단락: 기간 중 어떤 변화가 가장 두드러졌는지 (활동 패턴, 기술 스택, 작업 방식 등), "
                    "2단락: 저장소에서 집중한 영역과 그 배경, "
                    "3단락: 이러한 변화가 팀이나 프로젝트에 미칠 장기적 영향을 설명해 주세요."
                ),
            ),
            (
                "future_focus",
                "차기 목표 및 실행 로드맵",
                (
                    "Summary와 위 분석들을 참고하여 다음 기간(6개월)을 위한 상위 3개 목표와 "
                    "각 목표별 구체적 실행 계획을 작성해 주세요. 각 목표에는 (1) 달성 기준(측정 가능한 지표), "
                    "(2) 예상 장애물, (3) 성공을 위한 핵심 액션을 포함하세요."
                ),
            ),
        ]
