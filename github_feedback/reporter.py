...
class Reporter:
    ...
    def _build_witch_critique_section(self, metrics: MetricSnapshot) -> List[str]:
        ...
        # Opening curse
        lines.append(f"_{metrics.witch_critique.opening_curse}_")
        lines.append("")

        # Render each critique as a dark-themed card
        for i, critique in enumerate(metrics.witch_critique.critiques, 1):
        ...
        lines.append(f'    {metrics.witch_critique.closing_prophecy}')
        lines.append(f'  </p>')
        lines.append(f'</div>')
        lines.append("")
    ...
    def generate_markdown(self, metrics: MetricSnapshot) -> Path:
        ...
        sections = [
            ...
            # 10. Witch's Critique - Harsh but constructive feedback
            self._build_witch_critique_section(metrics),
            # 11. Spotlight Examples - Concrete evidence
            self._build_spotlight_section(metrics),
            # 12. Tech Stack - Technical breadth
