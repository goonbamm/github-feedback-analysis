...
class YearInReviewReporter:
    ...
    def create_year_in_review_report(
        ...
        lines.extend(self._generate_communication_skills_section(repository_analyses))
...
"""
    ...
    def _generate_communication_skills_section(
        self, repository_analyses: List[RepositoryAnalysis]
    ) -> List[str]:
        ...
        if total_review_tone_quality:
            skill_level, skill_name, skill_emoji = self._get_skill_level(avg_review_quality, "리뷰")
...
"""
    ...
    def _get_skill_level(self, quality: float, skill_type: str) -> tuple:
    ...
    def _create_mastery_bar(self, quality: float) -> str:
